    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=0, default=0, max_digits=8, verbose_name='цена, руб.')),
                ('quantity', models.SmallIntegerField(default=0, verbose_name='количество на складе, шт.')),
